...
class MegaCloud extends models_1.VideoExtractor {
    ...
    async extract(embedIframeURL, referer = 'https://hianime.to') {
        ...
        try {
            ...
            const { data: bypassData } = await axios_1.default.get(bypassUrl);
            if (!(bypassData === null || bypassData === void 0 ? void 0 : bypassData.sources) || !Array.isArray(bypassData.sources) || bypassData.sources.length === 0) {
